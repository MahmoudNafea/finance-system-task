...
import { AR_DASHBOARD_TRANSLATIONS } from '../i18n/ar';
import { DashboardLanguage } from '../i18n/dashboard-translations.types';
import { EN_DASHBOARD_TRANSLATIONS } from '../i18n/en';
